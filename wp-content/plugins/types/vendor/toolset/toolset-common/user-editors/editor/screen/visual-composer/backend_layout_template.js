...
ToolsetCommon.UserEditor.VisualComposerBackendLayoutTemplate = function( $ ) {
	...
	self.overlay					+= "<p><strong>" + toolset_user_editors_vc_layout_template_i18n.template_overlay.title + "</strong></p>";
	self.overlay					+= "<p>" + toolset_user_editors_vc_layout_template_i18n.template_overlay.text + "</p>";
	self.overlay					+= "<p>";
	self.overlay						+= "<a href='" + toolset_user_editors_vc_layout_template_i18n.template_editor_url + "' target='_blank' class='button button-secondary js-wpv-layout-template-overlay-info-link'>" + toolset_user_editors_vc_layout_template_i18n.template_overlay.button + "</a>";
	self.overlay					+= '</p><p>';
	self.overlay						+= "<a href='#' class='wpv-ct-apply-user-editor-basic js-wpv-ct-apply-user-editor js-wpv-ct-apply-user-editor-basic' data-editor='basic'>" + toolset_user_editors_vc_layout_template_i18n.template_overlay.discard + "</a>";
	self.overlay					+= "</p>";
	self.overlay				+= "</div>";
	self.overlay			+= "</div>";
